...
client.on('message', async msg => {
    ...
    msg.reply("Este canal de atendimento é exclusivo para o envio de dados de acesso ao laudo.  Demais solicitações favor contactar o tel/whatsapp 35 3429-6850.");
  // msg.reply("🍻");
